package com.evil.kesu.entity.custom;
...
public class MantisEntity extends AnimalEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TemptGoal(this, 1.25D, Ingredient.ofItems(ModItems.KES_INGOT), false));
    ...
    public boolean isBreedingItem(ItemStack stack) {
        return stack.isOf(ModItems.KES_INGOT);
    }
